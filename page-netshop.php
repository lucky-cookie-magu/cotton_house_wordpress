...
<head>
    ...
    <title>ネットショップ | Cotton house - コットンハウス -</title>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/netshop.css">
...
<body>
    ...
    <main><!-- ネットショップ -->
        ...
        <div class="title">
            <h2><img class="main-title1" src="<?php echo get_template_directory_uri(); ?>/img/img5/netshop-ja.png" alt="ネットショップ"></h2>
            <img  class="main-subtitle1" src="<?php echo get_template_directory_uri(); ?>/img/img5/netshop-en.png" alt="net shop">
        </div>
        ...
        <div class="netshop">
            <div class="creema">
                <a href="https://www.creema.jp/"><img src="<?php echo get_template_directory_uri(); ?>/img/img5/netshop-img1.png" alt="creema"></a>
                <h3><a href="https://www.creema.netjp/">creemaへ</a></h3>
            </div>
            <div class="minne">
                <a href="https://minne.com/"><img src="<?php echo get_template_directory_uri(); ?>/img/img5/netshop-img2.png" alt="minne"></a>
                 <h3><a href="https://minne.com/">minneへ</a></h3>
            </div>
        </div>
        
        <div class="description">
            <p>ひとつひとつ手作りで制作しているため、作品はどれも一点物です。<br>
                同じ商品であっても布合わせで一つひとつ風合いが異なります。<br>
                各オンラインショップには見本ではなく、実際にお手元に届く品を掲載しております。<br>
                「お問い合わせ」からもご希望の作品をオーダーメイドで承ります。<br>
                お気軽にお問い合わせください。
            </p>
        </div>
        
        <div class="button1">
            <a href="https://hcr13.cmnet.co.jp/wp/contact/">オーダーメイドのお問合せはこちら</a>
        </div>
