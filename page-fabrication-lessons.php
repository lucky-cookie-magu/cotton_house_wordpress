<?php
/*
Template Name: fabrication-lessons
*/
?>
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/fabrication-lessons.css">
...
<body>
    ...
    <main><!-- 制作と教室について -->
        ...
        <div class="title">
            <h2><img class="main-title1" src="<?php echo get_template_directory_uri(); ?>/img/img3/fabrication-lessons-ja.png" alt="制作と教室について"></h2>
            <img  class="main-subtitle1" src="<?php echo get_template_directory_uri(); ?>/img/img3/fabrication-lessons-en.png" alt="fabrication and lessons">
        </div>
        ...
        <div class="business">
            <div class="fabrication-and-order">
                <a href="https://hcr13.cmnet.co.jp/wp/fabrication/"><img src="<?php echo get_template_directory_uri(); ?>/img/img3/fabrication-lessons-img1.png" alt="制作について"></a>
                <h3><a href="https://hcr13.cmnet.co.jp/wp/fabrication/">制作はこちら</a></h3>
                <p>店舗では様々な作品を販売しています。バッグ、ポシェット、ポーチ、お財布など、さまざまな作品を直接お手に取ることができます。<br>
                    また店舗ではオーダーメイドも承っております。ご来店にて内容をお伺いしますので、お気軽にお問い合わせください。</p>
            </div>
            
            <div class="patchwork-lessons">
                <a href="https://hcr13.cmnet.co.jp/wp/lessons/"><img src="<?php echo get_template_directory_uri(); ?>/img/img3/fabrication-lessons-img2.png" alt="教室について"></a>
                <h3><a href="https://hcr13.cmnet.co.jp/wp/lessons/">教室はこちら</a></h3>
                <p>ワークショップコースとレッスンコースがあります。ワークショップコースでは６つのコースから作りたい物を選べます。<br>
                   レッスンコースでは週に１度、講師の元で学びながらご自分の好きなものを作ることができます。</p>
            </div>           
        </div>
